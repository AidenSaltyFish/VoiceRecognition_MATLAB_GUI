function [isFound,speaker] = isRecordSpeakerMatch(audioRecordData,speaker_names,codebook)

audioRecordData = audioRecordData / max(abs(audioRecordData));
mfccCoe = mfccCoefExtract(audioRecordData,48000); %得到测试人语音的Mel倒谱系数
