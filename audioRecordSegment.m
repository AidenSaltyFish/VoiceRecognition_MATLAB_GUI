function audioVoice = audioRecordSegment(audioRecordData,numSegment)

audio = audioRecordData;
...
for voiceIndex=1:numSegment
    ...
    audioVoice = [audioVoice audioRecordData(prefixLen+voiceStart*frameInc : prefixLen+voiceEnd*frameInc , :)];
